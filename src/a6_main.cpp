...
void classMorph(int studentNumber) {
	...
	segsBefore.push_back(Segment(522/2, 530/2, 522/2, 428/2));
	segsBefore.push_back(Segment(397/2, 438/2, 474/2, 443/2));
	segsBefore.push_back(Segment(561/2, 445/2, 640/2, 439/2));
	segsBefore.push_back(Segment(318/2, 598/2, 263/2, 447/2));
	segsBefore.push_back(Segment(394/2, 361/2, 634/2, 359/2));
	segsBefore.push_back(Segment(433/2, 645/2, 602/2, 638/2));
	segsBefore.push_back(Segment(433/2, 637/2, 462/2, 556/2));
	segsBefore.push_back(Segment(601/2, 629/2, 581/2, 558/2));
	segsBefore.push_back(Segment(480/2, 573/2, 523/2, 566/2));

	segsAfter.push_back(Segment(522/2, 534/2, 515/2, 448/2));
	segsAfter.push_back(Segment(403/2, 471/2, 481/2, 471/2));
	segsAfter.push_back(Segment(556/2, 462/2, 633/2, 459/2));
	segsAfter.push_back(Segment(347/2, 585/2, 297/2, 459/2));
	segsAfter.push_back(Segment(406/2, 419/2, 613/2, 403/2));
	segsAfter.push_back(Segment(433/2, 605/2, 604/2, 592/2));
	segsAfter.push_back(Segment(436/2, 598/2, 472/2, 557/2));
	segsAfter.push_back(Segment(601/2, 583/2, 574/2, 549/2));
	segsAfter.push_back(Segment(482/2, 563/2, 524/2, 570/2));
...
int main()
{
	...
	// try { classMorph(1); }        catch(...) {cout << "classMorph Failed!" << endl;}
